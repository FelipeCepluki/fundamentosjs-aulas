class JogoDaMemoria {
    ...
    constructor({tela}) {
        ...
        this.heroisIniciais = [
            ...
            {img: './arquivos/baimax.png', nome: 'baimax'},
    ...
    esconderHerois(herois) {
        ...
        // quando nao usamos: (exemplo do id), o JS entende que que o nome é o mesmo do valor.
        // Ex. id: id, vira id,
    ...
    verificarSelecao(id, nome) {
        ...
        switch(heroisSelecionados) {
            case 0:
                // adicionar a escolha na lista, esperando pela proxima clicada
                this.heroisSelecionados.push(item)
                break;
            case 1:
                // se a quantidade de escolhidos for 1, significa
                // que o suario só pode escolher mais um
                ...
                // aqui verificamos se são ids diferentes para o usuario nao clicar duas vezes no mesmo
                opcao1.id !== item.id
                ) {
